...
const Portfolio: React.FC = () => {
  ...
  const defaultProjects: Project[] = [
    ...
    },
    {
      ...
      description: 'A productivity app for managing tasks and projects with real-time collaboration features, built using Flutter and Firebase.',
    ...
    },
    {
      ...
      description: 'A beautiful weather application with location-based forecasts, interactive maps, and customizable widgets.',
    ...
    },
    {
      ...
      description: 'A comprehensive UI component library for Flutter developers with 50+ customizable widgets and screens.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Explore my latest projects and mobile applications. Each project represents 
            my passion for creating exceptional user experiences.
          </p>
        </div>
